...
import { PrismaClient, Prisma, PlanTier, UserRole, FiscalStatus, PeriodStatus, BudgetStatus, LineType } from '@prisma/client';
import * as argon2 from 'argon2';

// Ensure Prisma can read DATABASE_URL regardless of the current working directory.
...
async function main(): Promise<void> {
  ...
  for (let i = 0; i < 12; i += 1) {
    ...
    let status: PeriodStatus = PeriodStatus.OPEN;
  ...
  const kpis: Array<{
    ...
    formula: string;
    unit: string;
    threshold_warn: Prisma.Decimal;
    threshold_critical: Prisma.Decimal;
  }> = [
    {
      code: 'CA',
      ...
      formula: 'SUM(REVENUE)',
      unit: 'FCFA',
      threshold_warn: new Prisma.Decimal('15000000.00'),
      threshold_critical: new Prisma.Decimal('10000000.00'),
    },
    {
      code: 'EBITDA',
      label: 'EBITDA',
      formula: 'CA - OPEX',
      unit: 'FCFA',
      threshold_warn: new Prisma.Decimal('3000000.00'),
      threshold_critical: new Prisma.Decimal('1000000.00'),
    },
    {
      code: 'MARGE',
      label: 'Marge Brute',
      ...
      unit: '%',
      threshold_warn: new Prisma.Decimal('25.00'),
      threshold_critical: new Prisma.Decimal('15.00'),
    },
    {
      code: 'RUNWAY',
      ...
      unit: 'semaines',
      threshold_warn: new Prisma.Decimal('12.00'),
      threshold_critical: new Prisma.Decimal('8.00'),
    },
    {
      code: 'DSO',
      ...
      formula: '(AR / Sales) * 30',
      unit: 'jours',
      threshold_warn: new Prisma.Decimal('45.00'),
      threshold_critical: new Prisma.Decimal('60.00'),
    },
  ];
  ...
  for (const line of budgetLines) {
    await prisma.budgetLine.upsert({
      ...
      update: {
        ...
        amount_actual: new Prisma.Decimal(line.amount_actual),
